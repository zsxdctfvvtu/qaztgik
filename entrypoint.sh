...
if [[ -z "${Vless_Path}" ]]; then
  Vless_Path="/7a3c107a-400e-4a55-9442-d3e8aed0efb6"
fi
echo ${Vless_Path}

if [[ -z "${Vless_UUID}" ]]; then
  Vless_UUID="7a3c107a-400e-4a55-9442-d3e8aed0efb6"
fi
echo ${Vless_UUID}

if [[ -z "${Vmess_Path}" ]]; then
  Vmess_Path="/d1c135d6-488d-4ec9-a691-2c314780305f"
fi
echo ${Vmess_Path}

if [[ -z "${Vmess_UUID}" ]]; then
  Vmess_UUID="d1c135d6-488d-4ec9-a691-2c314780305f"
fi
echo ${Vmess_UUID}
